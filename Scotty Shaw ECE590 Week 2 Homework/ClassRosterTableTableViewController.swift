//
//  ClassRosterTableTableViewController.swift
...
class ClassRosterTableTableViewController: UITableViewController {
    ...
    @IBAction func unwindToList (segue: UIStoryboardSegue) {
        let source: StudentViewController = segue.sourceViewController as! StudentViewController
        let item: ClassRosterItem = source.classRosterItem
        self.tableView.reloadData()
    }
    
    func loadInitialData() {
        var item1 = ClassRosterItem()
        item1.studentDesc = "Shoot"
        self.classRosterItems.append(item1)
        var item2 = ClassRosterItem()
        item2.studentDesc = "Guard"
